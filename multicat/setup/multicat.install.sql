...
-- Filename: plugins/multicat/setup/multicat.install.sql
-- Purpose: Создаёт таблицу связей для плагина Multicat и мигрирует существующие
--          категории из cot_pages. Таблица заполняется при установке автоматически.
-- Date=Sep 12, 2026
-- package multicat
-- version 1.7.9
-- author webitproff
